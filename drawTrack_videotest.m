function drawTrack_videotest(x,y,r,angles)
...
%for each mic
b= abs(sqrt( r.^2.*(cos(rads).^2) - r.^2+a^2 ) +r.*cos(rads));
...
%convert to pixels
xtoplot= 904*xtoplot+353;
ytoplot= -828*ytoplot+255;
xbtoplot= 904*xbtoplot+353;
ybtoplot= -828*ybtoplot+255;
